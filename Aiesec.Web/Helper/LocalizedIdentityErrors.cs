...
namespace Aiesec.Web.Helper
{
    public class LocalizedIdentityErrors : IdentityErrorDescriber
    {
        ...
        public LocalizedIdentityErrors(ValidationErrors validationErrors)
        {
        ...
        {
            return new IdentityError { Code = nameof(DuplicateUserName), Description = _validationErrors.ErrUserNameExists(userName) };
        }
